...
namespace IFlight.Common.JobServer.Common
{
    public class SqlHelper
    {
        ...
        {
            var connectionString = "Data Source=192.168.2.229;Database=IFltCommDB;User ID=all;Password=SDFer98kd*&8834sdlfjerfgs;pooling=true;";
            //var connectionString = ConfigurationManager.ConnectionStrings["JinRiAirIFltCommDBReadConnStr"].ToString().Trim();
